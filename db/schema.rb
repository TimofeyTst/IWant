...
ActiveRecord::Schema[7.0].define(version: 2022_12_25_142428) do
  ...
  create_table "collection_saved_posts", force: :cascade do |t|
    t.integer "user_id", null: false
    t.integer "post_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["post_id"], name: "index_collection_saved_posts_on_post_id"
    t.index ["user_id"], name: "index_collection_saved_posts_on_user_id"
  end
  ...
  add_foreign_key "collection_saved_posts", "posts"
  add_foreign_key "collection_saved_posts", "users"
